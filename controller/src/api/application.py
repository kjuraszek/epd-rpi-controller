...
class TornadoApplication(tornado.web.Application):
    ...
    def __init__(self, view_manager: ViewManager):
        ...
        self._api_routes = [
            tornado.web.url(
                r"/api/status", StatusHandler, dict(view_manager=view_manager)
            ),
            tornado.web.url(
                r"/api/next", NextViewHandler, dict(view_manager=view_manager)
            ),
            tornado.web.url(
                r"/api/prev", PreviousViewHandler, dict(view_manager=view_manager)
            ),
            tornado.web.url(
                r"/api/current_display",
                CurrentDisplayHandler,
                dict(view_manager=view_manager),
            ),
        ]
        setup_swagger(
            self._api_routes,
