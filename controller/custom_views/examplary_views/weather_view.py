...
class WeatherView(BaseView):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        if None in (weather_key, weather_lat, weather_lon):
            ...
            self.url = (
                f"https://api.openweathermap.org/data/2.5/weather?lat={weather_lat}&lon={weather_lon}"
    ...
    def _epd_change(self, first_call: bool) -> None:
        ...
        font = ImageFont.truetype(
            "/usr/share/fonts/truetype/msttcorefonts/Impact.ttf", 70
        )
    ...
    def _conditional(self, *args: Any, **kwargs: Any) -> bool:
        ...
        if bool(kwargs["first_call"]) or (
            (temp_temperature, temp_pressure, temp_humidity, temp_wind)
            != (self.temperature, self.pressure, self.humidity, self.wind)
        ):
