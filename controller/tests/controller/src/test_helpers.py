...
from src.helpers import BaseThread, WrappedTitle, signal_handler, wrap_text, wrap_titles, view_conditional, view_fallback
...
class TestHelpers:
    ...
    def test_wrap_titles(self, mocker):
        ...
        wrapped_titles = wrap_titles(100, 100, font, ['Lorem testum testum', 'Lorem second testum testum'])
